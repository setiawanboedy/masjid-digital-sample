    ...
    <form wire:submit.prevent='store'>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="mb-3" wire:ignore>
                    ...
                    <select id="searchable-dropdown1" name="donatur_id" wire:model='donatur_id'>
            ...
            <div class="col-sm-12 col-md-12 col-lg-4">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" @disabled($isDonatur) name="name" id="name"
            ...
            <div class="col-sm-12 col-md-12 col-lg-4">
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('donatur_code') is-invalid @enderror" @disabled($isDonatur) name="donatur_code" id="donatur_code"
            ...
            <div class="col-sm-12 col-md-12 col-lg-4">
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('nomor') is-invalid @enderror" @disabled($isDonatur) name="nomor" id="nomor"
            ...
            <div class="col-sm-12 col-md-12 col-lg-6">
                ...
                <select class="form-select @error('gender') is-invalid @enderror" @disabled($isDonatur) name="gender" id="gender" wire:model.live.debounce.300ms='gender'>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-4">
                ...
                <select class="form-select @error('program_id') is-invalid @enderror" name="program_id" id="program_id"wire:model.live.debounce.300ms='program_id'>
            ...
            <div class="col-sm-12 col-md-12 col-lg-4">
                ...
                <select class="form-select @error('asbab_id') is-invalid @enderror" @disabled($isCS) name="asbab_id" id="asbab_id" wire:model.live.debounce.300ms='asbab_id'>
