<footer class="bg-white border border-gray-200 fixed bottom-0 inset-x-0 w-screen z-[999] rounded-md shadow">
    <div class="mx-auto max-w-screen-md py-2 flex items-center justify-evenly">
      ...
      <button class="flex flex-col items-center">
        ...
        <p class="text-sm pt-[2px]">Transaksi</p>
      </button>
      <a href="/src/views/profile.html" class="flex flex-col items-center">
        <svg class="" stroke="currentColor" fill="grey" stroke-width="0" viewBox="0 0 24 24" aria-hidden="true" height="24"
          width="24" xmlns="http://www.w3.org/2000/svg">
