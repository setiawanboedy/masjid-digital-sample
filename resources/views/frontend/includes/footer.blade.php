<footer class="bg-white border border-gray-200 fixed bottom-0 inset-x-0 w-screen z-[999] rounded-md shadow">
    <div class="mx-auto max-w-screen-md py-2 flex items-center justify-evenly btm-nav">
      <button class="{{ request()->is('/') ? 'text-utama active' : '' }}">
      ...
      <button class="{{ request()->is('event') ? 'text-utama active' : '' }}">
        <a href="/event" wire:navigate class="flex flex-col items-center">
          ...
          <p class="text-sm pt-[2px] {{ request()->is('event*') ? 'text-utama' : '' }}">Event</p>
        </a>
      </button>
      <button class="{{ request()->is('transaksi') ? 'text-utama active' : '' }}">
      ...
      <button class="{{ request()->is('profil') ? 'text-utama active' : '' }}">
