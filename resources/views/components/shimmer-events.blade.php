<div class="grid grid-cols-2 gap-4 px-4">
    ...
    <div role="status" class="max-w-sm p-4 animate-pulse md:p-6">
        <div class="flex items-center justify-center h-72 w-full mb-4 bg-gray-300 rounded"
        >
        ...
        <div class="h-2 bg-gray-200 rounded-full mb-2.5 w-64"></div>
        <div class="h-2 bg-gray-200 rounded-full mb-2.5 w-64"></div>
        <div class="h-2 bg-gray-200 rounded-full w-64 "></div>
