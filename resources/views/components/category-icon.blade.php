<div>
    @if ($categoryKey == 'SERIES')
        <svg stroke="grey" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round"
